...
predict_clicked = st.sidebar.button("Predict Salary")
 
# Result — only shown after the user clicks the button
...
if predict_clicked:
    ...
    st.info("Set the employee level in the sidebar and click **Predict Salary** to see the result.")
